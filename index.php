...
<html lang="en">
  <head>
    ...
    <?php 
        ...
        $content = mysqli_query($con,"SELECT * FROM tovar"); 
        $content_trash = mysqli_query($con,"SELECT * FROM trash");
    ?>
  ...
  <body>
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            <?php for ($i=0; $i < mysqli_num_rows($content_trash); $i++) {  ?>
            <?php
                $result_trash = $content_trash->fetch_assoc();
            ...
            ?>
                ...
                <div class="row">
                    <div class="col-3">
                        <img src='<?php echo $result_trash['img'] ?>' class="w-100">
                    </div>
                    <div class="col-4 mt-2">
                        <h5><?php echo $result_trash['name'] ?></h5>                        
                    </div>
                    <div class="col-2 mt-2 px-0 text-center">
                        <h5><?php echo $result_trash['цена'] ?>  <span>₽</span></h5>                        
                    </div>
        ...
        <?php $result = $content->fetch_assoc(); ?>
            <div class="col-3">   
                <img src='<?php echo $result['img'] ?>' class="w-100">
                <div class="pizz"> 
                    <h3><?php echo $result['name'] ?></h3>   
                    <p class="text-secondary"><?php echo $result['описание'] ?></p>
                </div>  
                <div class="row">
                    <div class="col-6">
                        <h3><?php echo $result['цена'] ?> <span>₽</span></h3>                        
                    </div>
                    <div class="col-6">
                        <form action="trash.php" method="get">
                            <input name="id_pica"  style=' display: none' value=<?php echo $result['id'] ?>>
